...
public class MovieCatalogResource {
    ...
    private final TrendingMovieClientService trendingMovieClientService;

    public MovieCatalogResource(RestTemplate restTemplate,
                                MovieInfoService movieInfoService,
                                UserRatingService userRatingService,
                                TrendingMovieClientService trendingMovieClientService) {

        this.restTemplate = restTemplate;
        this.movieInfoService = movieInfoService;
        this.userRatingService = userRatingService;
        this.trendingMovieClientService = trendingMovieClientService;
    }
    ...
    public List<Movie> getTopMovies() {
        return trendingMovieClientService.getTrendingMovies(10);
    }
